...
```{r, fig.align='center', fig.cap=capFig("Affichage des 40 individus qui cntribue le plus à la formation des axes en fonction de leur groupe de revenu"), fig.width=11, fig.height=6}
...
|       Il s'agit ici de faire l'ACP que sur les variables d'empruntes écologiques et de mettre les autres variables (de dévéloppement) en quantitatives supplémentaires.
